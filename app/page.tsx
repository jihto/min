                ...
                <main className="relative z-10 w-full">
                            ...
                            <div className="relative max-w-6xl mx-auto">
                                ...
                                >
                                    ...
                                    <div className="max-w-2xl">
                                        <p className="text-slate-200 dark:text-slate-400 text-lg leading-relaxed border-l-2 border-cyan-500/30 dark:border-cyan-400/30 pl-6">
                                    ...
                                    <div className="pt-8 flex flex-wrap items-center gap-4 pointer-events-auto">
                                        <button className="h-12 px-8 rounded-full bg-zinc-100 text-zinc-950 text-sm font-semibold hover:bg-cyan-500 hover:text-white transition-all duration-300 flex items-center gap-2 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/30">
                                            Start Solving
                                            <ArrowRight className="w-4 h-4" />
                                        </button>
                                        <div className="flex items-center gap-4 px-6 py-3 rounded-full border border-zinc-800 bg-black/20 backdrop-blur-sm hover:border-cyan-500/30 transition-colors">
                    ...
                    <section id="analytics" className="h-screen w-full flex flex-col items-center justify-center text-center px-6 pointer-events-none">
                        <div className="relative z-20 space-y-12">
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-cyan-400/60 font-mono">TRACKING METRICS THAT MATTER</p>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24">
                                ...
                                <div className="flex flex-col items-center gap-2">
                                    ...
                                    <span className="text-xs text-zinc-500 uppercase tracking-widest border-t border-cyan-500/20 pt-4 w-full">Concepts Mastered</span>
                                </div>
                                {/* Stat 2 */}
                                <div className="flex flex-col items-center gap-2">
                                    <div className="text-5xl md:text-7xl font-light text-white tracking-tight flex items-start">
                                    ...
                                    <span className="text-xs text-zinc-500 uppercase tracking-widest border-t border-cyan-500/20 pt-4 w-full">Avg. Time / Question</span>
                                </div>
                                {/* Stat 3 */}
                                <div className="flex flex-col items-center gap-2">
                                    <div className="text-5xl md:text-7xl font-light text-white tracking-tight flex items-start">
                                    ...
                                    <span className="text-xs text-zinc-500 uppercase tracking-widest border-t border-cyan-500/20 pt-4 w-full">Current Streak</span>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="cta" className="min-h-screen w-full bg-transparent flex flex-col items-center justify-center py-24 px-6 border-t border-zinc-900 relative overflow-hidden">
                        ...
                        <div className="z-10 text-center space-y-6 max-w-2xl mx-auto">
                            <div className="w-16 h-16 mx-auto rounded-2xl bg-zinc-900 border border-cyan-500/30 flex items-center justify-center mb-6 shadow-2xl shadow-cyan-500/20">
                            ...
                            <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-8">
                                <button className="w-full md:w-auto bg-white text-black px-8 py-3.5 rounded-lg text-sm font-semibold hover:bg-cyan-500 hover:text-white transition-all shadow-lg shadow-white/10 hover:shadow-cyan-500/30">
                                    Launch Dashboard
                                </button>
                                <button className="w-full md:w-auto bg-transparent border border-zinc-800 text-white px-8 py-3.5 rounded-lg text-sm font-semibold hover:border-cyan-500 hover:text-cyan-400 transition-all">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full mt-24 z-10">
                            <div className="border border-zinc-800/50 bg-zinc-900/20 p-6 rounded-lg backdrop-blur-sm hover:border-cyan-500/50 transition-colors group">
                                <span className="text-xs font-mono text-cyan-500 mb-2 block">PHASE 01</span>
                                <h3 className="text-sm font-medium text-white group-hover:text-cyan-400 transition-colors">Diagnostic</h3>
                            ...
                            <div className="border border-zinc-800/50 bg-zinc-900/20 p-6 rounded-lg backdrop-blur-sm hover:border-cyan-500/50 transition-colors group">
                                ...
                                <h3 className="text-sm font-medium text-white group-hover:text-cyan-400 transition-colors">Execution</h3>
                            ...
                            <div className="border border-zinc-800/50 bg-zinc-900/20 p-6 rounded-lg backdrop-blur-sm hover:border-cyan-500/50 transition-colors group">
                                ...
                                <h3 className="text-sm font-medium text-white group-hover:text-cyan-400 transition-colors">Review</h3>
